...
?>
    <!--    <main class="main-topbar-padding register-page">-->
    <!--        <section>-->
    ...
    <!--                            <input type="text" id="first_name" name="email" placeholder="Votre prénom ">-->
    <!--                        </div>-->
    <!--                        <div class="form-group">-->
    ...
    <!--                            <input type="password" placeholder="Rétapez votre mot de passe" id="password_confirmation"-->
    <!--                                   name="password_confirmation">-->
    <!--                        </div>-->
    <!--                        <button class="btn btn-primary login-button">S'incrire</button>-->
    <!--                        <a href="login.php" class="login-outer-text">Connexion</a>-->
    <!--                    </form>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--        </section>-->
    ...
    <main class="register-page">
        <div class="container-1 wrapper">
            ...
            <form action="register.php" method="post" class="login-form">
                ...
                <button class="btn btn-primary login-button">S'incrire</button>
                <a href="login.php<?= isset($redirect_url) && $redirect_url ? '?redirect_url=' . $redirect_url : '' ?>" class="login-outer-text">Connexion</a>
            </form>
        </div>
    </main>
<?php
